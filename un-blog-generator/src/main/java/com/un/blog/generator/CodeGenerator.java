...
public class CodeGenerator {
    ...
    // 生成的代码放到哪个工程中
    private static String PROJECT_NAME = "un-blog-article";
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://101.42.4.26:13306/"+ DATABASE_NAME +"?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=GMT%2B8");
        ...
        pc.setParent("com.un.blog"); //父包名
        pc.setController(MODULE_NAME+".controller"); // com.un.blog.aritcle.controller
        ...
        pc.setEntity("entities");//实体类存储包名 com.un.blog.entities
        ...
        strategy.setTablePrefix("un_"); // 去掉表前缀
